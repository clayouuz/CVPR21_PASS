...
#PackNet(args.task,local_ep=args.local_ep,local_rep_ep=args.local_local_ep,device=args.device,prune_instructions= 1 - args.store_rate)
class PackNet(nn.Module):

    def __init__(self, n_tasks, local_ep,local_rep_ep,prune_instructions=.9, prunable_types=(nn.Conv2d, nn.Linear),device =None,feature_extractor=None,numclass=None):
